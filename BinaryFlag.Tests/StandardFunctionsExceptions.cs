...
{
    [TestClass]
    public class StandardFunctionsExceptions
    {
        [TestMethod]
        public void SetBinaryFlag_WrongIndex()
        {
            ...
            {
                Standard.Functions.BinaryFunctions.SetBinaryFlag(0, true);
            });
        }
        [TestMethod]
        public void SetBinaryFlag_ByteArrayOutOfRange_Length()
        {
            ...
            {
                Standard.Functions.BinaryFunctions.SetBinaryFlag(1, true, bytes);
            });
        }
        [TestMethod]
        ...
        public void HasBinaryFlag_WrongIndex()
        {
            ...
            Assert.ThrowsException<IndexOutOfRangeException>(() =>
            {
                Standard.Functions.BinaryFunctions.HasBinaryFlag(0, bytes);
            });
        }
        [TestMethod]
        ...
        public void FindBinaryIndexes_ByteArrayOutOfRange_Length()
        {
            ...
            Assert.ThrowsException<ArgumentException>(() =>
            {
                Standard.Functions.BinaryFunctions.FindBinaryIndexes(bytes);
            });
        }
        [TestMethod]
